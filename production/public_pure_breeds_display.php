             ...
             ?> 
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i><strong><?php echo $row['name']; ?></strong></i><?php echo '<a href="public_new_livestock_selected_breed.php?animal_breed_id='. $row['id'] .'&user_key='. $userhashid .'">'?><button data-toggle="tooltip" title="Register <?php echo $row['name']; ?> breed" type="button" class="btn btn-success btn-xs pull-right">
