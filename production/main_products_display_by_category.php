    ...
    ?>
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="x_title">
                    <medium><a href="index.php">Dashboard</a> <i class="fa fa-play-circle"></i> <a href="main_products_display.php">Products</a> <i class="fa fa-play-circle"></i> <b>Product Category index <?php echo !empty($dispcatetype)?$dispcatetype:''; ?> - <?php echo !empty($categonamea)?$categonamea:''; ?></b></medium>
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM products WHERE categoryid = '$categoryname'";
