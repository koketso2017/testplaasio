    ...
    ?>
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="x_title">
                    <medium><a href="index.php">Dashboard</a> <i class="fa fa-play-circle"></i> <a href="public_pure_breeds_display.php">Livestock Pure Breeds</a> <i class="fa fa-play-circle"></i> <a href="public_pure_breeds_display_by_category.php?categoryname=<?php echo $Categoryname ?>&user_key=<?php echo $userhashid?>"><?php echo !empty($anictname)?$anictname:''; ?> Pure Breeds</a> <i class="fa fa-play-circle"></i> Displaying <b><?php echo !empty($anictname)?$anictname:''; ?> and <?php echo !empty($alphabetid)?$alphabetid:''; ?></b> index pure breeds</medium> 
                    </ul>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                       ...
                       <?php while ($row=$result->fetch_array(MYSQLI_ASSOC)) { ?>
                        <ul class="pagination pagination-split">
                          <li><a href="public_pure_breeds_display_by_category_alphabet.php?alphabetid=<?php echo $row['name']?>&categoryname=<?php echo $Categoryname?>&user_key=<?php echo $userhashid?>"><?php echo $row['name']?></a></li> 
                        </ul> 
                      <?php } ?> 
                      </div>   
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM plaas_breeds WHERE categoryid = '$Categoryname' AND name LIKE '$alphabetid%'";
             ...
             ?> 
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i><strong><?php echo $row['name']; ?></strong></i><?php echo '<a href="public_new_livestock_selected_breed.php?animal_breed_id='. $row['id'] .'&user_key=<?php echo $userhashid?>">'?><button data-toggle="tooltip" title="Register <?php echo $row['name']; ?> breed" type="button" class="btn btn-success btn-xs pull-right">
