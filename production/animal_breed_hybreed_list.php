<?php
  ...
  if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
   $pid = null;
    ...
    $sql = "DELETE FROM `plaas_hy_breeds` WHERE id = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($pid));   
    echo '<meta content="1;animal_breed_hybreed_list.php?breed_sucess_delete" http-equiv="refresh" />';
    MyData::disconnect(); 
} 
?>
        <!-- page content -->
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Hybrid Breeds <small>Livestock index</small></h3>
              </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><?php echo '<a href="animal_breed_hybreed_add.php">'?><button type="button" class="btn btn-dark"><i class="fa fa-plus"></i></button><?php echo '</a>'?></li>
  ...
  border-radius: 4px; '> 
    ...
    ?>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings" style="background-color: #7F5217;"> 
                            ...
                            <th class="column-title">Cross C</th>
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM plaas_hy_breeds order by modified DESC";
             ...
             ?>
                <tr>  
                    ...
                    <td><?php echo !empty($breadaname)?$breadcname:''; ?></td>
                    <td><?php echo !empty($countryname)?$countryname:''; ?></td> 
                    <td><?php echo $row['modified']; ?></td>
                    <td>
                    <?php echo '<a href="main_animal_hybrid_edit.php?animal_id='. $row['id'] .'">'?><button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button><?php echo '</a>'?>  
...
<script type="text/javascript">
  ...
  if(iAnswer){
    window.location = 'animal_breed_hybreed_list.php?id=' + Id;
  }
  }
