                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      ?>
                        <li>
                          <i class="fa fa-adjust user-profile-icon"></i> <?php echo !empty($gender)?$gender:''; ?>
                        </li>
                        <?php
                      } 
                      ...
                      ?>
                        <li>
                          <i class="fa fa-calendar user-profile-icon"></i> <?php echo !empty($dateofbith)?$dateofbith:''; ?>
                        </li>
                        <?php
                      } 
                        if ($country == '') { 
                      ...
                      ?>
                        <li>
                        <i class="fa fa-map-marker user-profile-icon"></i> <?php echo !empty($country)?$country:''; ?>. <?php echo !empty($citytown)?$citytown:''; ?>. <?php echo !empty($citystreet)?$citystreet:''; ?>
                        </li>
                        <?php
                      } 
                        if ($residentialad == '') { 
                      ...
                      ?> 
                        <li>
                          <i class="fa fa-home user-profile-icon"></i> <?php echo !empty($residentialad)?$residentialad:''; ?>
                        </li>
                        <?php
                      } 
                        if ($useraddress == '') { 
                      ...
                      ?>
                        <li class="m-top-xs">
                          <i class="fa fa-phone user-profile-icon"></i> <?php echo !empty($countrycode)?$countrycode:''; ?> <?php echo !empty($contact)?$contact:''; ?>
                        </li>
                        <?php
                      }
                      ?>
                  ...
                  <?php
                    if(isset($_GET['profile_update_picture_success']))
                       {  
                        $msgcx = "
                         <div class='alert alert-success alert-dismissible fade in' role='alert' style='color: #000C2C; background-color: #99C68E; border-color: #d6e9c6; margin-left: 0%; border-radius: 4px;'>
                            ...
                            <ul class="messages">
                              <li>
                                ...
                                <div class="message_wrapper">
                                  <h4 class="heading">Account registration</h4>
                                  <p style="" class="message">message</p>
                                  <br />
                                  <p class="url">
                                    <span class="fs1 text-info" aria-hidden="true" data-icon=""></span>
                                    <a href="#"><i class="fa fa-paperclip"></i> User Terms And Conditions </a>
                                  </p>
                                </div>
                              </li>   
...
<?php
  ...
  if(isset($_POST['savecat']))
   { 
    ...
    echo '<meta content="2;main_user_profile.php?profile_sucess" http-equiv="refresh" />';// redirects user view page after 3 seconds.
    MyData::disconnect(); 
    } 
     else
      {        
      ...
      echo '<meta content="2;main_user_profile.php?profile_update_success" http-equiv="refresh" />';// redirects user view page after 3 seconds. 
    MyData::disconnect();  
      }
   }
...
if(isset($_POST['picupdate']))
{
  ...
  if (!isset($_FILES['image']['tmp_name'])) {  
    echo '<meta content="2;main_user_profile.php?profile_update_picture_error" http-equiv="refresh" />';// redirects user view page after 3 seconds.
  }else{
  ...
  $image_size= getimagesize($_FILES['image']['tmp_name']);
    ...
    if ($image_size==FALSE) {   
           echo '<meta content="2;main_user_profile.php?profile_update_picture_error" http-equiv="refresh" />';// redirects user view page after 3seconds.
 ...
 if (!empty($_POST)) { 
      ...
      if($q->execute())
      {     
           echo '<meta content="2;main_user_profile.php?profile_update_picture_success" http-equiv="refresh" />';// redirects user view page after 3 seconds.
      }
      else
      {  
           echo '<meta content="2;main_user_profile.php?profile_update_picture_error" http-equiv="refresh" />';// redirects user view page after 3seconds.
