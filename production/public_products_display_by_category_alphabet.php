    ...
    ?>
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="x_title">
                    <medium><a href="index.php">Dashboard</a> <i class="fa fa-play-circle"></i> <a href="public_products_display.php">Products</a> <i class="fa fa-play-circle"></i> <b>Product Category index <?php echo !empty($categonamea)?$categonamea:''; ?> and Order index <?php echo !empty($alphabetid)?$alphabetid:''; ?></b></medium>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                       ...
                       <?php while ($row=$result->fetch_array(MYSQLI_ASSOC)) { ?>
                        <ul class="pagination pagination-split">
                          <li><a href="public_products_display_by_category_alphabet.php?alphabetid=<?php echo $row['count']?>&categoryname=<?php echo $categoryname?>"><?php echo $row['count']?></a></li> 
                        </ul>
                      <?php }
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM products WHERE categoryid = '$categoryname' AND tagid LIKE '$alphabetid%' AND userid = '$userid'";
