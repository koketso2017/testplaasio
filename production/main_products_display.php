    ...
    ?>
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="x_title">
                    <medium><a href="index.php">Dashboard</a> <i class="fa fa-play-circle"></i> <b>Displaying random farmers products out of <?php echo !empty($cont70)?$cont70:''; ?> </b></medium>
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM products order by RAND() LIMIT 51";
             ...
             ?> 
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <?php echo '<a href="main_product_display_information.php?productid='. $row['id'].'&productIuniqueid='.$row['uniqueid'].'">'?><p data-toggle="tooltip" title="Product Tag ID" class="brief"><i><strong><?php echo $row['tagid']; ?></strong></i> </p><?php echo '</a>'?>
