          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Animals <small> <b>registration selection</b></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <?php    
                      $pdo = MyData::connect(); 
                      $sql = "SELECT * FROM categories WHERE category = 'Livestock' order by id DESC";
                              foreach ($pdo->query($sql) as $row) {   
                              $procat = $row['name'];
                      ?> 
                       
                      <?php echo '<a href="add_new_livestock_pure_breed.php?livestock_category_id='. $row['id'] .'&selected_product='. $procat . '">'?>
                      <div class="col-md-55">
                        <div class="thumbnail">
