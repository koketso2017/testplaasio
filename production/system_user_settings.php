...
<?php
  ...
  if(isset($_POST['savecat']))
   { 
    ...
    echo '<meta content="2;system_user_settings.php?settings_update_success" http-equiv="refresh" />';// redirects user view page after 3 seconds.
    MyData::disconnect(); 
    } 
     else
      {        
      ...
      echo '<meta content="2;system_user_settings.php?settings_update_successfull" http-equiv="refresh" />';// redirects user view page after 3 seconds. 
    MyData::disconnect();  
      }
   }
?>