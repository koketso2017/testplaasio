          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Livestock <small> <?php echo !empty($proname)?$proname:''; ?> pure breeds</small> </h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Animals <small> <a href="add_new_livestock.php">Livestock selection</a> <i class="fa fa-chevron-right"></i> <b><a href="#">breed selection</a></b></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <?php    
                      ...
                      $sql = "SELECT * FROM plaas_breeds WHERE categoryid = '$mypurebreedid' order by id DESC";
                              ...
                              $procoug = $row['countryoforigin'];

                     $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                     $sql = "SELECT * FROM `categories` WHERE id = '$procat'";
                     $q = $pdo->prepare($sql);
                     $q->execute(array());
                     $data = $q->fetch(PDO::FETCH_ASSOC);
                     ...
                     $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                     $sql = "SELECT * FROM `plaas_countries` WHERE id = '$procoug'";
                     $q = $pdo->prepare($sql);
                     $q->execute(array());
                     $data = $q->fetch(PDO::FETCH_ASSOC);
                     $countrname= $data['name'];
                      ?> 
                       
                      <?php echo '<a href="add_new_livestock_selected_breed.php?livestock_breed_category_id='. $row['id'] .'&selected_product_category='. $producname . '">'?>
                      <div class="col-md-55">
                        <div class="thumbnail">
                          ...
                          <div class="caption" style="margin-top: -2%;">
                            ...
                            <p style="font-size: 100%;"><i style="color: red;" class="fa fa-map-marker"></i> Origin: <font color="#7E3817;"><?php echo !empty($countrname)?$countrname:'';?></font></p><br><br>
                          </div>
                        </div>
                      </div>
                     <?php echo '</a>'?>  
