<?php
  ...
  if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
   $pid = null;
    ...
    $q = $pdo->prepare($sql);
    $q->execute(array($pid));   
    echo '<meta content="1;public_products_display.php?product_sucess_delete" http-equiv="refresh" />';
    MyData::disconnect(); 
} 
?>
    ...
    ?>
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="x_title">
                    <medium><a href="farmers-management-application.php">Dashboard</a> <i class="fa fa-play-circle"></i> <b>Displaying random farmers products out of <?php echo !empty($cont70)?$cont70:''; ?> </b></medium>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                       ...
                       <?php while ($row=$result->fetch_array(MYSQLI_ASSOC)) { ?>
                        <ul class="pagination pagination-split">
                          <li><a href="public_products_display_by_alphabet.php?alphabetid=<?php echo $row['count']?>&user_key=<?php echo $userhashid?>"><?php echo $row['count']?></a></li> 
                        </ul>
                      <?php }
                       ...
                       <?php while ($row=$result->fetch_array(MYSQLI_ASSOC)) { ?>
                        <ul class="pagination pagination-split alert-default" data-toggle="tooltip" title="Display by category <?php echo $row['name']?>">
                          <li><a href="public_products_display_by_category.php?categoryname=<?php echo $row['id']?>&user_key=<?php echo $userhashid?>"><?php echo $row['name']?></a></li> 
                        </ul>
                      <?php } ?> 
                      </div>   
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM products WHERE userid = '$userid' order by RAND() LIMIT 51";
             foreach ($pdo->query($sql) as $row) {     
                ...
                $query_ams_setting2 = "SELECT * FROM plaas_product_images WHERE id = '$anproductid' ORDER BY eid DESC";
             ...
             ?> 
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <?php echo '<a href="public_product_display_information.php?productid='. $row['id'].'&productIuniqueid='.$row['uniqueid'].'">'?><p data-toggle="tooltip" title="Product Tag ID" class="brief"><i><strong><?php echo $row['tagid']; ?></strong></i> </p><?php echo '</a>'?>
                            ...
                            <div class="right col-xs-5 text-center">
                              ...
                              <img src="images/<?php echo !empty($cbreedicon)?$cbreedicon:''; ?>" alt=" Icon" class="img-rounded profile-user-img img-responsive"> 
                                ...
                                ?>
                              <img src="uploads/thumb/<?php echo !empty($productidpicture)?$productidpicture:''; ?>" alt=" Icon" class="img-rounded profile-user-img img-responsive"> 
                                <?php
                                }
                                ?>  
                            </div>
                          ...
                          <div class="col-xs-12 bottom text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 emphasis">
                              <?php echo '<a href="public_new_livestock_selected_breed_update.php?product_id='. $row['id'] .'">'?><button data-toggle="tooltip" title="View | Edit <?php echo $row['tagid']; ?> details" type="button" class="btn btn-dark btn-xs">
...
<script type="text/javascript">
  ...
  if(iAnswer){
    window.location = 'public_products_display.php?id=' + Id;
  }
  }
