          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Breed <small>species</small></h3>
              </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><?php echo '<a href="main_pure_breeds_display.php">'?><button type="button" class="btn btn-dark"><i class="fa fa-bars"></i></button><?php echo '</a>'?></li>
                  ...
                  <div class="x_content"> 
                    <form class="form-horizontal form-label-left input_mask" method="POST"> 
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                        <input type="text" data-toggle="tooltip" title="Production type, ie: meat or dairy" style="width: 100%;" name="brepro" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Production type, ie: meat or dairy">
...
<?php
  ...
  if(isset($_POST['savecat']))
   { 
    ...
    $count=mysqli_query($con,"SELECT * FROM plaas_breeds WHERE name = '$breedname'");
    if(mysqli_num_rows($count) < 1)
    {  
    $pdo = MyData::connect();
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $sql1 = "INSERT into plaas_breeds(name, categoryid, productiontype, countryoforigin, description, icon) VALUES (?,?,?,?,?,?)";   
    $q1 = $pdo->prepare($sql1);
    $q1->execute(array($breedname,$breedcategory,$breedproduct,$breedcountry,$breedescription,$breedicon));      
    echo '<meta content="2;main_pure_breeds_display.php?breed_sucess" http-equiv="refresh" />';// redirects user view page after 3 seconds.
    MyData::disconnect();  
    } 
     else
      {        
      echo '<meta content="2;main_pure_breeds_display.php?breed_error" http-equiv="refresh" />';// redirects user view page after 3 seconds. 
      }
   }
?>   
