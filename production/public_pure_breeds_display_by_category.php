    ...
    ?>
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="x_title">
                    <medium><a href="index.php">Dashboard</a> <i class="fa fa-play-circle"></i> <a href="public_pure_breeds_display.php">Livestock Pure Breeds</a> <i class="fa fa-play-circle"></i> Displaying <b><?php echo !empty($anictname)?$anictname:''; ?></b> index pure breeds</medium>
