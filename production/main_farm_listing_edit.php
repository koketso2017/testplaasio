<?php
  ...
  if ( null==$myfarmid ) {
   echo '<meta content="2;main_user_farms_display.php?farm_id_error" http-equiv="refresh" />';// redirects user view page after 3 seconds. 
  } 
...
<?php
  ...
  if(isset($_POST['savecat']))
   {  
    ...
    echo '<meta content="2;main_farm_listing_edit.php?myfarm_id='. $myfarmid .'&farm_sucess_update" http-equiv="refresh" />';// redirects user view page after 3 seconds.
    MyData::disconnect();
   }
?>   
