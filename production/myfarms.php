...
?>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><?php echo '<a href="myfarm_add.php">'?><button type="button" class="btn btn-dark"><i class="fa fa-plus"></i></button><?php echo '</a>'?></li>
  ...
  border-radius: 4px; '> 
    ...
    ?>
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM plaas_data_farm WHERE userid = '$userid' order by modified DESC";
             ...
             ?>
                <tr>
                    ...
                    <td><?php echo $row['recordate']; ?></td>
                    <td><?php echo $row['modified']; ?></td>
                    <td>
                    <?php echo '<a href="myfarm_edit.php?myfarm_id='. $row['farmID'] .'">'?><button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button><?php echo '</a>'?>  
