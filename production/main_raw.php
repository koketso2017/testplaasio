...
if ($result01 = mysqli_query($con, "SELECT sum(total) as productstotal FROM products WHERE categoryid = '1'")) {
...
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$query_ams_settings = "SELECT * FROM products WHERE categoryid = '1' ORDER by id DESC LIMIT 1";
$q = $pdo->prepare($query_ams_settings);
$q->execute(array());
$data = $q->fetch(PDO::FETCH_ASSOC); 
$lastsignmodct = $data['upsign'];

if ($result010 = mysqli_query($con, "SELECT sum(total) as uptotal FROM products WHERE categoryid = '1' ORDER by id DESC LIMIT 1")) {
 
while ($row = mysqli_fetch_assoc($result010))
{ 
   $upprocductscattle =  $row['uptotal'];
}
    /* close result set */
    mysqli_free_result($result010);
}

$updownpercent =  ($upprocductscattle / 100 * $procductscattle); 
$upprocductscattle_string = number_format($updownpercent, 2);
...
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$query_ams_settings = "SELECT * FROM products WHERE categoryid = '2' ORDER by id DESC LIMIT 1";
$q = $pdo->prepare($query_ams_settings);
$q->execute(array());
$data = $q->fetch(PDO::FETCH_ASSOC); 
$lastsignmodgt = $data['upsign'];

if ($result011 = mysqli_query($con, "SELECT sum(total) as uptotal FROM products WHERE categoryid = '2' ORDER by id DESC LIMIT 1")) {
...
if ($result03 = mysqli_query($con, "SELECT sum(total) as productstotal FROM products WHERE categoryid = '8'")) {
...
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$query_ams_settings = "SELECT * FROM products WHERE categoryid = '8' ORDER by id DESC LIMIT 1";
$q = $pdo->prepare($query_ams_settings);
$q->execute(array());
$data = $q->fetch(PDO::FETCH_ASSOC); 
$lastsignmodhs = $data['upsign'];

if ($result012 = mysqli_query($con, "SELECT sum(total) as uptotal FROM products WHERE categoryid = '8' ORDER by id DESC LIMIT 1")) {
...
if ($result03 = mysqli_query($con, "SELECT sum(total) as productstotal FROM products WHERE categoryid = '14'")) {
...
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$query_ams_settings = "SELECT * FROM products WHERE categoryid = '14' ORDER by id DESC LIMIT 1";
$q = $pdo->prepare($query_ams_settings);
$q->execute(array());
$data = $q->fetch(PDO::FETCH_ASSOC); 
$lastsignmodsp = $data['upsign'];

if ($result013 = mysqli_query($con, "SELECT sum(total) as uptotal FROM products WHERE categoryid = '14' ORDER by id DESC LIMIT 1")) {
...
if ($result04 = mysqli_query($con, "SELECT sum(total) as productstotal FROM products WHERE categoryid = '15'")) {
...
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$query_ams_settings = "SELECT * FROM products WHERE categoryid = '15' ORDER by id DESC LIMIT 1";
$q = $pdo->prepare($query_ams_settings);
$q->execute(array());
$data = $q->fetch(PDO::FETCH_ASSOC); 
$lastsignmodpg = $data['upsign'];

if ($result015 = mysqli_query($con, "SELECT sum(total) as uptotal FROM products WHERE categoryid = '15' ORDER by id DESC LIMIT 1")) {
...
if ($result05 = mysqli_query($con, "SELECT sum(total) as productstotal FROM products")) {
...
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$query_ams_settings = "SELECT * FROM products WHERE categoryid = '4' ORDER by id DESC LIMIT 1";
$q = $pdo->prepare($query_ams_settings);
$q->execute(array());
$data = $q->fetch(PDO::FETCH_ASSOC); 
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"> <i class="fa fa-arrows"></i>   <span>P l a a s   </span> <i class="fa fa-arrows"></i></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-globe"></i> Continents<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="main_continents.php">Continent List</a></li>
                      <li><a href="main_continent_add.php">Add Continent</a></li> 
                       <?php  
                       ...
                       <li><a href="main_continent_view_statistics_<?php echo $row['name']?>.php?selected_continent_id=<?php echo $row['id']?>&selected_continent_name=<?php echo $row['name']?>"><?php echo $row['name']?></a></li>
                       <?php } ?> 
                    </ul>
                  </li>
                  <li><a><i class="fa fa-ioxhost"></i> Countries<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="main_countries.php">Country List</a></li>
                      <li><a href="main_country_add.php">Add Country</a></li> 
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-map-marker"></i> Farm & Locations<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="main_farm_listing.php">Farm List</a></li>
                      <li><a href="main_farm_listing_add.php">Add Farm</a></li>
                  ...
                  <li><a><i class="fa fa-codepen"></i> Livestock <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu"> 
                        <li><a>Breed Listing<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu"><a href="animal_breed_list.php">Pure Breeds</a>
                            </li>
                        ...
                        <li><a>Add Breed<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu"><a href="animal_breed_add.php">Pure Breed</a>
                            </li>
                            <li><a href="animal_breed_cross_add.php">Cross Breed</a>
                            </li>
                            <li><a href="animal_breed_hybreed_add.php">Hybrid</a>
                            </li>
                          </ul>
                        </li>
                  ...
                  <li><a><i class="fa fa-ge"></i>Soil types<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="main_soil_list.php">Soil list</a></li> 
                      <li><a href="main_soil_add.php">Add Soil</a></li> 
                    </ul>
                  </li>
            ...
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  ?>
                    <img src="images/<?php echo $pictu ?>" alt="">Administrator
                    <span class=" fa fa-angle-down"></span>
                  <?php
                  }
                  ?>
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="main_user_profile.php"> Profile</a></li>
                    <li>
                      <a href="main_user_settings.php"> 
                        <span>Settings</span>
                      </a>
                    </li>
