...
?>
          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>International <small><a href="main_continents.php">Continents </a> <i class="fa fa-caret-right"></i> <a href="main_countries.php">All countries </a> <i class="fa fa-caret-right"></i> <a href="main_countries_view_by_continent.php?continent_id=<?php echo !empty($Continentid)?$Continentid:''; ?>&user_key=<?php echo !empty($userhashid)?$userhashid:''; ?>"><?php echo !empty($secontname)?$secontname:''; ?></a></small></h2>
  ...
  border-radius: 4px; '> 
    ...
    ?>
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM plaas_countries WHERE continent = '$Continentid' order by name ASC";
