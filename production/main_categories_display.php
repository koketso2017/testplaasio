    ...
    ?>
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="x_title">
                    <medium><a href="index.php">Dashboard</a> <i class="fa fa-play-circle"></i> <b>Displaying <?php echo !empty($cont67)?$cont67:''; ?> out of <?php echo !empty($cont67)?$cont67:''; ?> records</b></medium>
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM categories order by RAND() LIMIT 51";
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          ...
                          if ($category == 'livestock') {
                            ?>
                            <h4 class="brief" style="font-style: italic; color: red; text-decoration: underline;"><i><strong><a href="main_pure_breeds_display_by_category.php?categoryname=<?php echo $row['id']?>&user_key=<?php echo $userhashid?>"><?php echo $row['name']?></a></strong></i></h4>
                            <?php
                          }if ($category == 'crops'){
                          ?>
