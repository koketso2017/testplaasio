<?php
  ...
  if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
   $pid = null;
    ...
    $q = $pdo->prepare($sql);
    $q->execute(array($pid));   
    echo '<meta content="1;main_continents_display.php?cont_sucess_delete" http-equiv="refresh" />';
    MyData::disconnect(); 
} 
?>
  ...
  border-radius: 4px;
  width: 100%;'> 
         <strong> Continent Registration Error!</strong>   Continent already exist in the database.
         </div>
         ";  
    }
    ...
    ?>
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="x_title">
                    <medium><a href="index.php">Dashboard</a> <i class="fa fa-play-circle"></i> <b>Displaying world continents</b></medium>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                       ...
                       <?php while ($row=$result->fetch_array(MYSQLI_ASSOC)) { ?>
                        <ul class="pagination pagination-split">
                          <li><a href="#.php?alphabetid=<?php echo $row['name']?>&user_key=<?php echo $userhashid?>"><?php echo $row['name']?></a></li> 
                        </ul>
                      <?php } ?> 
                      </div> 
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM plaas_continents order by name ASC LIMIT 30";
             ...
             ?> 
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i><strong><?php echo '<a data-toggle="modal"  data-target="#confirm-profile" href="main_continents_display_details.php?continent_id='. $row['id'] .'">'?><i class="fa fa-globe pull-left"></i><?php echo $row['name']; ?> <?php echo '</a>'?></strong></i></h4>
                            ...
                            <div class="right col-xs-5 text-center">
                              <?php echo '<a data-toggle="modal"  data-target="#confirm-profile" href="main_continents_display_details.php?continent_id='. $row['id'] .'">'?><img src="images/<?php echo $row['icon'] ?>" alt="Continent Icon" class="img-rounded img-responsive"><?php echo '</a>'?>
                            </div>
                          </div>
                          <div class="col-xs-12 bottom text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 emphasis"> 
                              <?php echo '<a href="main_continent_edit.php?continent_id='. $row['id'] .'">'?><button data-toggle="tooltip" title="Edit <?php echo $row['name']; ?> details" type="button" class="btn btn-dark btn-xs">
...
<script type="text/javascript">
  ...
  if(iAnswer){
    window.location = 'main_continents_display.php?id=' + Id;
  }
  }
