    ...
    ?>
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="x_title">
                    <medium><a href="index.php">Dashboard</a> <i class="fa fa-play-circle"></i> <b>Displaying <?php echo !empty($cont68)?$cont68:''; ?> out of <?php echo !empty($cont68)?$cont68:''; ?> records</b></medium>
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM plaas_soil order by RAND() LIMIT 51";
