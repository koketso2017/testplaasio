<?php
  ...
  if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
   $pid = null;
    ...
    $q = $pdo->prepare($sql);
    $q->execute(array($pid));   
    echo '<meta content="1;animal_breed_list.php?breed_sucess_delete" http-equiv="refresh" />';
    MyData::disconnect(); 
} 
?>
        <!-- page content -->
  ...
  border-radius: 4px; '> 
    ...
    ?>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings" style="background-color: #7F5217;"> 
                            ...
                            <th class="column-title">Coutry/region of origin</th>    
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM plaas_breeds order by modified DESC";
             ...
             ?>
                <tr>  
                    ...
                    <td>
                    <?php echo '<a href="main_animal_edit.php?animal_id='. $row['id'] .'">'?><button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button><?php echo '</a>'?>  
                    <a class="btn btn-danger" onclick="deleteLivestock(<?php echo $row['id']; ?>);" href="javascript:;" data-original-title="<?php echo $_data['delete_text'];?>"><i class="fa fa-trash-o"></i></a>
                    </td>  
                </tr>
                <?php
                }
...
<script type="text/javascript">
  ...
  if(iAnswer){
    window.location = 'animal_breed_list.php?id=' + Id;
  }
  }
