          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo !empty($tagid)?$tagid:''; ?> <small> <a href="main_products_display.php">Products</a> <i class="fa fa-chevron-right"></i> <?php echo '<a href="main_products_display_by_category.php?categoryname='. $categoname .'&user_key=<?php echo $userhashid?>">'?> <?php echo !empty($categonamea)?$categonamea:''; ?> selection <?php echo '</a>'?> <i class="fa fa-chevron-right"></i> <b><a href="#"><?php echo !empty($bredname)?$bredname:''; ?></a></b></small></h2>
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="POST">  
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback" >   
                       <select data-toggle="tooltip" title="selected product relationship" style="width: 100%;" class="form-control" name="prbrtrl" id="inputEmail3">
                        ...
                        <option value="Young one">Young One</option>
  ...
  if(isset($_POST['savecat']))
   {  
    ...
    $q1->execute(array($livechip,$livetag,$livecolor,$livesex,$livedob,$liveuser,$livefarmid,$liveyoung,$liverelation,$livetotal,$productsize,$lastmod,$product_id)); 
      echo '<meta content="2;main_new_livestock_selected_breed_update.php?pname='. $categonamea .'&pcatego='. $dispcatetype .'&ptotal='. $livetotal .'&userid='. $liveuser .'&product_id='. $product_id .'" http-equiv="refresh" />';// redirects user view page after 3 seconds.
    MyData::disconnect();  
   }
?>    