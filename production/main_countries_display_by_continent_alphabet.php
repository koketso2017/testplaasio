          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><?php echo !empty($secontname)?$secontname:''; ?> <small>Continent index</small></h3>
              </div>
    ...
    ?>
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="x_title">
                    <medium><a href="index.php">Dashboard</a> <i class="fa fa-play-circle"></i> <a href="main_countries_display_by_continent.php?continent_id=<?php echo $Continentid ?>&user_key=<?php echo $userhashid ?>"> Displaying <?php echo !empty($secontname)?$secontname:''; ?>n countries</a> <i class="fa fa-play-circle"></i> <a href="#.php">Index <b><?php echo !empty($alphabetid)?$alphabetid:''; ?></b> </a></medium>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                       ...
                       <?php while ($row=$result->fetch_array(MYSQLI_ASSOC)) { ?>
                        <ul class="pagination pagination-split">
                          <li><a href="main_countries_display_by_continent_alphabet.php?alphabetid=<?php echo $row['name']?>&continent_id=<?php echo $Continentid?>&user_key=<?php echo $userhashid?>"><?php echo $row['name']?></a></li> 
                        </ul>
                      <?php } ?> 
                      </div> 
            ...
            <?php    
             $pdo = MyData::connect(); 
             $sql = "SELECT * FROM plaas_countries WHERE continent = '$Continentid' AND name LIKE '$alphabetid%' order by name ASC";
